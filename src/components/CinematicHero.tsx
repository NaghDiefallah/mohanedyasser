...
const CinematicHero = () => {
  ...
  return (
    <>
      <section 
        ref={containerRef}
        className="relative min-h-[150vh] flex items-start overflow-hidden bg-black"
        ...
        <div className="sticky top-0 h-screen w-full flex items-center">
          ...
          <div className="relative z-30 container mx-auto px-8 md:px-16 lg:px-24">
            <div className="max-w-[50%]">
              ...
              >
                <p 
                  className="text-sm md:text-base font-light tracking-wide max-w-md mb-8"
                ...
                {/* Reveal accent line */}
                <motion.div 
                  className="h-[1px] w-16 mb-8 origin-left"
                  style={{ 
                    scaleX: lineScale,
                ...
                >
                  <span 
                    className="text-xs uppercase tracking-[0.25em] font-medium transition-colors duration-300 group-hover:text-white"
